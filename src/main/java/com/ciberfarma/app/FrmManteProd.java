...
public class FrmManteProd extends JFrame {
	...
	void llenaCombo() {
		...
		List<Proveedor> lstProveedors = em.createQuery("select p from Proveedor p").getResultList();
	...
	void listado() {
		...
		List<Producto> lstProductos = em.createQuery("select j from Producto j").getResultList();
		txtSalida.setText("");
		for (Producto j : lstProductos) {
			txtSalida.append(
					j.getId_prod() + " " + j.getDes_prod() + " " + j.getStk_prod() + " " + j.getPre_prod() + "\n");
		}
		em.close();
	}
